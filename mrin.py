...
def show_user_info(message):
    ...
    approval_expiry = "{expiry_date}"  # Assuming not approved, adjust if you have approval status information
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if handle_expired_access(user_id):
            response = "Your access has expired. Please contact owner @OFFICIALRINO to renew your access."
            bot.reply_to(message, response)
            return
